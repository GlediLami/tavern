...
describe('EndingScreen', () => {
  it('renders a victory ending and a return button', async () => {
    ...
    render(<EndingScreen adventureId="brackenmoor" sceneId="ending_victory" onReturn={onReturn} />);
  ...
  it('renders a defeat ending', () => {
    render(<EndingScreen adventureId="brackenmoor" sceneId="ending_pack" onReturn={() => {}} />);
